...
const Privacy = () => {
	return (
		<>
			...
			<div className="main-content py-10 mt-1 p-4 md:py-10 md:px-32 my-10">
				<h3>
				...
				<ul>
					...
					<li>
						General information in line with extant laws and
						regulations.
					</li>
				</ul>
				<p>
					This policy does not apply to the practices of third party
					agents, or people of which we do not exercise direct
					control, employment or management.
				</p>
				<h3>1. Consent: </h3>{" "}
				<p>
					By using this site, you have consented to our Privacy Policy
					and that you have the legal capacity to give consent.
				...
				<p>
					...
					but not limited to email address, name, phone number,
					physical address, location, photo, banking details (when you
					make purchases), online identifiers, etc.) from you when you
					set up a free account with Peculyn.com. While you can browse
					some sections of our site without being a registered member,
					certain activities (such as placing an order) do require
					registration. We do use your contact information to send you
					offers based on your previous orders and your interests. The
					information and personal data are as freely provided by you
					to us using any technology at the material time e.g. JWT,
					web tokens etc.
				</p>
				<h3>3. Use of Demographic and Profile Data</h3>
				<p>
				...
				<p>
					a. Your personal data on Peculyn shall be collected and
					processed in accordance with legitimate and lawful purpose
					consented to by you herein, provided that a further
					processing may be done only for archiving, scientific
					research, historical research or statistical purposes for
					public interest in line with extant regulations and laws.
				</p>
				<p>
					b. Personal data shall be adequate, accurate and without
					prejudice to the dignity of human person:
				</p>
				<p>
					c. Personal data shall be stored only for the period within
					which it is reasonably needed, and shall be secured against
					all foreseeable hazards and breaches such as theft,
					cyberattack, viral attack, dissemination, manipulations of
					any kind, damage by rain, fire or exposure to other natural
					elements.
				</p>
				<p>
					d. Our data collection shall depict that we owe a duty of
					care to you.
				</p>
				<p>
					e. We shall be accountable in line with extant laws and
					regulations.{" "}
				</p>
				...
				<p>
					...
					explicitly opt -in. We may disclose personal information if
					required to do so by law or in the good faith belief that
					such disclosure is reasonably necessary to respond to
					subpoenas, court orders, or other legal process. We may
					disclose personal information to law enforcement offices,
					third party rights owners, third-party vendors, contractors
					and suppliers who perform services for us or on our behalf
					and require access to such information to do that service,
					...
					or the general public. Peculyn and its affiliates will share
					some or all of your personal information with another
					business entity should we (or our assets) plan to merge
					with, or be acquired by that business entity. Should such a
				...
				<h3>7. Personal Date Retention Period</h3>
				<p>
					Peculyn will only keep your personal information for as long
					...
					requirements.) Upon request for account closure, your
					account will be closed but this closure will not involve
					deletion of historical records of the account for the
					reasons already stated. However, except as may be required
					by law or law enforcement agents and/or regulators, further
					processing of the personal information related to the
					account will cease from time of closure.
				</p>
				...
				<p>
					...
					identifiable information about you. Peculyn is not
					responsible for the privacy practices or the content of
					those linked websites.
				</p>
				<h3>10. Security Precautions</h3>
				<p>
					...
					access. However, please bear in mind that we cannot
					...
					environment. Most importantly, you are responsible for
					keeping your User ID and password secure and you should not
					disclose them to anyone.
				</p>
				<h3>11. Choice/Opt-Out</h3>
				<p>
					Peculyn provides all users with the opportunity to opt-out
					of receiving non-essential (promotional, marketing-related)
					communications from us on behalf of our partners, and from
					us in general, after setting up an account. If you want to
					remove your contact information from all Peculyn lists and
					newsletters, please visit
					https://www.Peculyn.com/unsubscribe. In the future, you can
					unsubscribe by clicking the one-click unsubscribe button
					located at the bottom of every email.
				</p>
				<h3>12. Advertisements on Peculyn.com</h3>
				<p>
				...
				<h3>13. Remedies, Questions and Contact</h3>
				<p>
					If observe or have good grounds that your privacy rights
					have been infringed or likely to be infringed by the use of
					our Site please lodge your complaints or questions regarding
					our policy to the following address: help@Peculyn.com. Our
					Data Protection Officer shall attend to them. Generally, you
					may contact us on any issue by mail to help@Peculyn.com.{" "}
				</p>
				<h3>14. Notification of Changes</h3>
				<p>
					Peculyn reserves the right to make changes and/or updates to
					this Privacy Policy from time to time, without prior notice,
					and the latest version on this policy will be posted on our
					websites. You are advised to view this Privacy Policy
					periodically for any changes. Changes to this Privacy Policy
					are effective when they are posted on our webpages.{" "}
				</p>
			</div>
		</>
	);
